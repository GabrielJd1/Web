...
namespace WebConsultasv10.Controllers
{
    ...
    public class FuncionariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdFuncionario,Nome,Salario,Ativo")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdFuncionario,Nome,Salario,Ativo")] Funcionarios funcionarios)
        {
            if (ModelState.IsValid)
            {
